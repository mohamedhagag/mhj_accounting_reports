...
class AccountPartnerLedger(models.TransientModel):
    ...
    def _print_report(self, data):
        ...
        return self.env.ref('mhj_account_reports.action_report_partnerledger').with_context(landscape=True).\
    ...
    def _print_excel_report(self, data):
        ...
        data = self._get_report_data(data)
        return self.env.ref('mhj_account_reports.action_report_partnerledger_xlsx').report_action(self, data=data)
